...
#[derive(
    Debug, Default, Eq, PartialEq, Copy, Clone, rkyv::Archive, rkyv::Serialize, rkyv::Deserialize,
)]
...
#[derive(Clone, Default, PartialEq, Debug, rkyv::Archive, rkyv::Serialize, rkyv::Deserialize)]
